...
이 문서는 구현 기준이며 공개 개인정보처리방침·약관을 대신하지 않는다. 공개 운영자명은 **AnJuHyun**, 지원 이메일은 [ajhajh503@gmail.com](mailto:ajhajh503@gmail.com), GitHub 계정은 `ajh1004ajh00`이다(2026-09-18 운영자 지정). [저장소 Issues](https://github.com/ajh1004ajh00/hwpx-desktop-plugin/issues)에서도 문제를 제보할 수 있다. 정책·약관 공개 URL과 플랫폼 적용 범위는 추가 확정이 필요하다.
