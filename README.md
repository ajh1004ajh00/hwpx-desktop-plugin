...
> 현재는 로컬 개발·검증 단계이며 전체 형식 호환성이나 심사 승인을 의미하지 않습니다.
...
| 신청서 공동 작성 | “팀명과 참가 목적을 해당 칸에 채워줘” | 자연어 대상 탐색·여러 항목 작성은 개발 예정 |

현재는 커서를 놓거나 텍스트를 선택한 뒤 요청합니다. 실제 사용 데모는 검증 후 추가할 예정입니다.
