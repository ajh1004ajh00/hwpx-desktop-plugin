...
1. 최신 한글메이트 플러그인을 설치하고, 새 대화에서 **“한글메이트 편집기를 열어줘”**라고 요청합니다.
2. 편집기의 **파일 → 열기**에서 HWP/HWPX 파일을 선택합니다.
3. 수정할 곳에 커서를 놓거나 텍스트를 선택한 뒤 AI에게 요청합니다.
4. **최근 AI 변경**과 문서를 확인하고, 파일 메뉴에서 저장합니다.

예를 들어 “선택한 문장을 간결하게 바꿔줘”, “현재 셀에 참가 목적을 써줘”, “선택한 글자를 굵게 바꿔줘”라고 요청할 수 있습니다.

일반 사용자는 Node.js나 로컬 서버를 설치할 필요가 없습니다. AI 편집에는 **WebMCP를 지원하는 앱의 내장 브라우저**가 필요합니다. 설치·업데이트 방법은 [시작 안내](docs/SITES-QUICKSTART.md)를 참고하세요.
